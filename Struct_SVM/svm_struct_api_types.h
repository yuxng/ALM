...
typedef struct struct_learn_parm {
  double epsilon;              /* precision for which to solve
				  quadratic program */
  double epsilon_init;         /* initial precision */
  ...
  char confile_write[200];           /* file for constraints */
  char confile_read[200];       /* file for read the previous constraints */
  ...
  int full_model;
  int is_wrap;
  double fractions[ITERATION_NUM];
  int iter;
  /* support vectors */
  CONSTSET cset;
} STRUCT_LEARN_PARM;
